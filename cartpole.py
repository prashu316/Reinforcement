...
#converting cartpole environment to tensorflow
...
#policy is used for evaluation while collect_policy is used for data collection
...
#the average return for running a certain policy over many episodes
...
#computing th return using the random policy
compute_avg_return(eval_env, random_policy, num_eval_episodes)

#a replay buffer is used in order to keep track of the previous data collected from the running of the environment
